    ...
    if (form) {
        ...
        function showStep(stepNumber) {
            ...
            if (currentStep === 5 && stepNumber === 6) {
                ...
                console.log("Ansettelsesdato finnes, går til steg 6:", 
                          "ansettelsesdato:", employmentDateInput.value,
                          "arbeidsgivernavn:", employerName,
                          "ansettelsestype:", employmentStatus);
            }
            ...
            if (currentStep === 6 && stepNumber === 7) {
                ...
                console.log("Brutto årsinntekt finnes, går til steg 7 (utdannelse):", 
                          "brutto årsinntekt:", grossIncomeInput.value);
            }
            ...
            if (currentStep === 7 && stepNumber === 8) {
                ...
                console.log("Utdannelse valgt, går til steg 8 (statsborgerskap):", 
                          "utdannelse:", educationInput.value);
            }
            ...
            if (currentStep === 8 && stepNumber === 8.5) {
                ...
                console.log("Statsborgerskap valgt, går til steg 8.5 (flyttet til Norge):", 
                          "statsborgerskap:", citizenshipInput.value);
            }
            ...
            if (currentStep === 8.5 && stepNumber === 10) {
                ...
                console.log("Dato flyttet til Norge valgt, går til steg 10 (fødselsnummer):", 
                          "dato:", livedInNorwayInput.value);
            }
        ...
        form.querySelectorAll('.chat-input').forEach(input => {
            input.addEventListener('input', (e) => {
                const button = e.target.closest('.chat-input-container, .country-search-container')?.querySelector('.chat-next-btn');
  ...
  const formProps = Object.fromEntries(formData);
            ...
            try {
                console.log("Forbereder API-kall med følgende data:", {
                    application: {
                        ...
                        LivedInMarketCountrySince: formProps.Citizenship !== "NO" ? new Date(formProps.LivedInMarketCountrySince).toISOString() : undefined
                    },
                    customer: {
    ...
    body: JSON.stringify({
      ...
      window.location.replace('axo-form.html');
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                if (livedInNorwayStep) {
                                    ...
                                    const livedInNorwayInput = livedInNorwayStep.querySelector('input[name="LivedInMarketCountrySince"]');
                                    if (livedInNorwayInput) {
        ...
        const countries = [
            {code: 'AF', name: 'Afghanistan'}, {code: 'AL', name: 'Albania'}, {code: 'DZ', name: 'Algerie'},
            {code: 'AS', name: 'Amerikansk Samoa'}, {code: 'AD', name: 'Andorra'}, {code: 'AO', name: 'Angola'},
            {code: 'AI', name: 'Anguilla'}, {code: 'AQ', name: 'Antarktis'}, {code: 'AG', name: 'Antigua og Barbuda'},
            {code: 'AR', name: 'Argentina'}, {code: 'AM', name: 'Armenia'}, {code: 'AW', name: 'Aruba'},
            {code: 'AU', name: 'Australia'}, {code: 'AT', name: 'Østerrike'}, {code: 'AZ', name: 'Aserbajdsjan'},
            {code: 'BS', name: 'Bahamas'}, {code: 'BH', name: 'Bahrain'}, {code: 'BD', name: 'Bangladesh'},
            {code: 'BB', name: 'Barbados'}, {code: 'BY', name: 'Hviterussland'}, {code: 'BE', name: 'Belgia'},
            {code: 'BZ', name: 'Belize'}, {code: 'BJ', name: 'Benin'}, {code: 'BM', name: 'Bermuda'},
            {code: 'BT', name: 'Bhutan'}, {code: 'BO', name: 'Bolivia'}, {code: 'BQ', name: 'Bonaire, Sint Eustatius og Saba'},
            {code: 'BA', name: 'Bosnia-Hercegovina'}, {code: 'BW', name: 'Botswana'}, {code: 'BV', name: 'Bouvetøya'},
            {code: 'BR', name: 'Brasil'}, {code: 'IO', name: 'Det britiske territoriet i Indiahavet'}, {code: 'BN', name: 'Brunei'},
            {code: 'BG', name: 'Bulgaria'}, {code: 'BF', name: 'Burkina Faso'}, {code: 'BI', name: 'Burundi'},
            {code: 'CV', name: 'Kapp Verde'}, {code: 'KH', name: 'Kambodsja'}, {code: 'CM', name: 'Kamerun'},
            {code: 'CA', name: 'Canada'}, {code: 'KY', name: 'Caymanøyene'}, {code: 'CF', name: 'Den sentralafrikanske republikk'},
            {code: 'TD', name: 'Tsjad'}, {code: 'CL', name: 'Chile'}, {code: 'CN', name: 'Kina'},
            {code: 'CX', name: 'Christmasøya'}, {code: 'CC', name: 'Kokosøyene'}, {code: 'CO', name: 'Colombia'},
            {code: 'KM', name: 'Komorene'}, {code: 'CD', name: 'Kongo, Den demokratiske republikken'}, {code: 'CG', name: 'Kongo'},
            {code: 'CK', name: 'Cookøyene'}, {code: 'CR', name: 'Costa Rica'}, {code: 'CI', name: 'Elfenbenskysten'},
            {code: 'HR', name: 'Kroatia'}, {code: 'CU', name: 'Cuba'}, {code: 'CW', name: 'Curaçao'},
            {code: 'CY', name: 'Kypros'}, {code: 'CZ', name: 'Tsjekkia'}, {code: 'DK', name: 'Danmark'},
            {code: 'DJ', name: 'Djibouti'}, {code: 'DM', name: 'Dominica'}, {code: 'DO', name: 'Den dominikanske republikk'},
            {code: 'EC', name: 'Ecuador'}, {code: 'EG', name: 'Egypt'}, {code: 'SV', name: 'El Salvador'},
            {code: 'GQ', name: 'Ekvatorial-Guinea'}, {code: 'ER', name: 'Eritrea'}, {code: 'EE', name: 'Estland'},
            {code: 'SZ', name: 'Eswatini'}, {code: 'ET', name: 'Etiopia'}, {code: 'FK', name: 'Falklandsøyene'},
            {code: 'FO', name: 'Færøyene'}, {code: 'FJ', name: 'Fiji'}, {code: 'FI', name: 'Finland'},
            {code: 'FR', name: 'Frankrike'}, {code: 'GF', name: 'Fransk Guyana'}, {code: 'PF', name: 'Fransk Polynesia'},
            {code: 'TF', name: 'De franske sørterritorier'}, {code: 'GA', name: 'Gabon'}, {code: 'GM', name: 'Gambia'},
            {code: 'GE', name: 'Georgia'}, {code: 'DE', name: 'Tyskland'}, {code: 'GH', name: 'Ghana'},
            {code: 'GI', name: 'Gibraltar'}, {code: 'GR', name: 'Hellas'}, {code: 'GL', name: 'Grønland'},
            ...
            {code: 'HM', name: 'Heard- og McDonaldøyene'}, {code: 'VA', name: 'Vatikanstaten'}, {code: 'HN', name: 'Honduras'},
            {code: 'HK', name: 'Hongkong'}, {code: 'HU', name: 'Ungarn'}, {code: 'IS', name: 'Island'},
            {code: 'IN', name: 'India'}, {code: 'ID', name: 'Indonesia'}, {code: 'IR', name: 'Iran'},
            {code: 'IQ', name: 'Irak'}, {code: 'IE', name: 'Irland'}, {code: 'IM', name: 'Man'},
            {code: 'IL', name: 'Israel'}, {code: 'IT', name: 'Italia'}, {code: 'JM', name: 'Jamaica'},
            {code: 'JP', name: 'Japan'}, {code: 'JE', name: 'Jersey'}, {code: 'JO', name: 'Jordan'},
            {code: 'KZ', name: 'Kasakhstan'}, {code: 'KE', name: 'Kenya'}, {code: 'KI', name: 'Kiribati'},
            {code: 'KP', name: 'Nord-Korea'}, {code: 'KR', name: 'Sør-Korea'}, {code: 'KW', name: 'Kuwait'},
            {code: 'KG', name: 'Kirgisistan'}, {code: 'LA', name: 'Laos'}, {code: 'LV', name: 'Latvia'},
            {code: 'LB', name: 'Libanon'}, {code: 'LS', name: 'Lesotho'}, {code: 'LR', name: 'Liberia'},
            {code: 'LY', name: 'Libya'}, {code: 'LI', name: 'Liechtenstein'}, {code: 'LT', name: 'Litauen'},
            {code: 'LU', name: 'Luxembourg'}, {code: 'MO', name: 'Macao'}, {code: 'MG', name: 'Madagaskar'},
            {code: 'MW', name: 'Malawi'}, {code: 'MY', name: 'Malaysia'}, {code: 'MV', name: 'Maldivene'},
            {code: 'ML', name: 'Mali'}, {code: 'MT', name: 'Malta'}, {code: 'MH', name: 'Marshalløyene'},
            {code: 'MQ', name: 'Martinique'}, {code: 'MR', name: 'Mauritania'}, {code: 'MU', name: 'Mauritius'},
            {code: 'YT', name: 'Mayotte'}, {code: 'MX', name: 'Mexico'}, {code: 'FM', name: 'Mikronesiaføderasjonen'},
            {code: 'MD', name: 'Moldova'}, {code: 'MC', name: 'Monaco'}, {code: 'MN', name: 'Mongolia'},
            {code: 'ME', name: 'Montenegro'}, {code: 'MS', name: 'Montserrat'}, {code: 'MA', name: 'Marokko'},
            {code: 'MZ', name: 'Mosambik'}, {code: 'MM', name: 'Myanmar'}, {code: 'NA', name: 'Namibia'},
            {code: 'NR', name: 'Nauru'}, {code: 'NP', name: 'Nepal'}, {code: 'NL', name: 'Nederland'},
            {code: 'NC', name: 'Ny-Caledonia'}, {code: 'NZ', name: 'New Zealand'}, {code: 'NI', name: 'Nicaragua'},
            {code: 'NE', name: 'Niger'}, {code: 'NG', name: 'Nigeria'}, {code: 'NU', name: 'Niue'},
            {code: 'NF', name: 'Norfolkøya'}, {code: 'MP', name: 'Nord-Marianene'}, {code: 'NO', name: 'Norge'},
            {code: 'OM', name: 'Oman'}, {code: 'PK', name: 'Pakistan'}, {code: 'PW', name: 'Palau'},
            {code: 'PS', name: 'Palestina, Staten'}, {code: 'PA', name: 'Panama'}, {code: 'PG', name: 'Papua Ny-Guinea'},
            {code: 'PY', name: 'Paraguay'}, {code: 'PE', name: 'Peru'}, {code: 'PH', name: 'Filippinene'},
            {code: 'PN', name: 'Pitcairnøyene'}, {code: 'PL', name: 'Polen'}, {code: 'PT', name: 'Portugal'},
            {code: 'PR', name: 'Puerto Rico'}, {code: 'QA', name: 'Qatar'}, {code: 'MK', name: 'Nord-Makedonia'},
            {code: 'RO', name: 'Romania'}, {code: 'RU', name: 'Russland'}, {code: 'RW', name: 'Rwanda'},
            {code: 'RE', name: 'Réunion'}, {code: 'BL', name: 'Saint-Barthélemy'}, {code: 'SH', name: 'Saint Helena, Ascension og Tristan da Cunha'},
            {code: 'KN', name: 'Saint Kitts og Nevis'}, {code: 'LC', name: 'Saint Lucia'}, {code: 'MF', name: 'Saint-Martin'},
            {code: 'PM', name: 'Saint-Pierre og Miquelon'}, {code: 'VC', name: 'Saint Vincent og Grenadinene'}, {code: 'WS', name: 'Samoa'},
            {code: 'SM', name: 'San Marino'}, {code: 'ST', name: 'São Tomé og Príncipe'}, {code: 'SA', name: 'Saudi-Arabia'},
            {code: 'SN', name: 'Senegal'}, {code: 'RS', name: 'Serbia'}, {code: 'SC', name: 'Seychellene'},
            {code: 'SL', name: 'Sierra Leone'}, {code: 'SG', name: 'Singapore'}, {code: 'SX', name: 'Sint Maarten'},
            {code: 'SK', name: 'Slovakia'}, {code: 'SI', name: 'Slovenia'}, {code: 'SB', name: 'Salomonøyene'},
            {code: 'SO', name: 'Somalia'}, {code: 'ZA', name: 'Sør-Afrika'}, {code: 'GS', name: 'Sør-Georgia og Sør-Sandwichøyene'},
            {code: 'SS', name: 'Sør-Sudan'}, {code: 'ES', name: 'Spania'}, {code: 'LK', name: 'Sri Lanka'},
            {code: 'SD', name: 'Sudan'}, {code: 'SR', name: 'Surinam'}, {code: 'SJ', name: 'Svalbard og Jan Mayen'},
            {code: 'SE', name: 'Sverige'}, {code: 'CH', name: 'Sveits'}, {code: 'SY', name: 'Syria'},
            {code: 'TW', name: 'Taiwan'}, {code: 'TJ', name: 'Tadsjikistan'}, {code: 'TZ', name: 'Tanzania'},
            {code: 'TH', name: 'Thailand'}, {code: 'TL', name: 'Øst-Timor'}, {code: 'TG', name: 'Togo'},
            {code: 'TK', name: 'Tokelau'}, {code: 'TO', name: 'Tonga'}, {code: 'TT', name: 'Trinidad og Tobago'},
            {code: 'TN', name: 'Tunisia'}, {code: 'TR', name: 'Tyrkia'}, {code: 'TM', name: 'Turkmenistan'},
            {code: 'TC', name: 'Turks- og Caicosøyene'}, {code: 'TV', name: 'Tuvalu'}, {code: 'UG', name: 'Uganda'},
            {code: 'UA', name: 'Ukraina'}, {code: 'AE', name: 'De forente arabiske emirater'}, {code: 'GB', name: 'Storbritannia'},
            {code: 'UM', name: 'USAs ytre småøyer'}, {code: 'US', name: 'USA'}, {code: 'UY', name: 'Uruguay'},
            {code: 'UZ', name: 'Usbekistan'}, {code: 'VU', name: 'Vanuatu'}, {code: 'VE', name: 'Venezuela'},
            {code: 'VN', name: 'Vietnam'}, {code: 'VG', name: 'Jomfruøyene (Storbritannia)'}, {code: 'VI', name: 'Jomfruøyene (USA)'},
            {code: 'WF', name: 'Wallis og Futuna'}, {code: 'EH', name: 'Vest-Sahara'}, {code: 'YE', name: 'Jemen'},
        ...
        function showEmploymentResponse() {
            ...
            console.log("Alle data er på plass, går videre:", 
                       "ansettelsesdato:", employmentDateInput.value,
                       "arbeidsgivernavn:", employerName,
                       "ansettelsestype:", employmentStatus);
        ...
        form.querySelectorAll('.non-employment-btn').forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                console.log("Non-employment valgt:", 
                          "type:", type,
                          "ansettelsesdato:", employmentDateInput.value);
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        if (employmentInput.value && employmentDateInput.value) {
                            ...
                            console.error("Kritisk feil: Mangler fortsatt nødvendig data for å gå videre fra non-employment");
                        }
                    }, 300);
                }, 700);
            });
